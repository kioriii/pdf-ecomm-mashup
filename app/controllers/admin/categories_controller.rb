# We want this categories_controller to be nested under admin. Because we want to have separate controllers for categories; admin gets one controller, and non-admins use another controller
